...
export const docQuery = onCall({ 
  ...
  try {
    ...
    const modelCandidates = [
      'googleai/gemini-2.5-flash',  // Faster, more efficient Gemini 1.5 model
      'gemini-2.5-flash',    // More capable Gemini 1.5 model as fallback
      'googleai/gemini-2.5-pro'     // Legacy PaLM model as final fallback
    ];
